<template>
  <div class="d-flex align-items-center mb-3 mt-1">
    <span class="badge rounded me-3 ms-1 badge-subtle-primary">
      <span class="fas fa-file-signature fs-2 text-primary"></span>
    </span>
    <div class="col">
      <h5 class="mb-0 text-primary position-relative">
        <span class="bg-200 dark__bg-1100 pe-3 fs-2">Stock Opname Form</span>
        <span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span>
      </h5>
      <p class="mb-0 fs--1"><a href="javascript:void(0)" class="text-dark">Martha Tilaar Shop</a> / Stock Opname (SO) Form</p>
    </div>
  </div>
      ...
      <div class="row flex-between-center gx-0">
        <div class="col-lg-auto d-flex align-items-center"><img class="img-fluid" src="@/assets/img/illustration/reports-greeting.png" alt="">
          <div class="ms-x1">
            ...
            <h4 class="mb-0 text-primary fw-bold"><span class="text-info fw-medium">Stock Opname (SO) Form</span></h4>
          </div>
        </div>
                    ...
                    <td class="text-success text-left" width="10">
                      <template v-if="flagclickFromStore == true">
                        <textarea
                          ...
                          placeholder=""
                          :disabled="dataTr103.docStatus == 'O'"
                        ></textarea>
                      </template>
                    </td>
...
export default {
  ...
  methods: {
    ...
    confirmTicket() {
      ...
      Swal.fire({
        title: "Confirm?",
        text: "Apakah Anda ingin mengkonfirmasi Ticket SO ini?",
        icon: "question",
        ...
        if (result.isConfirmed) {
          ...
          axios
            ...
            .then((res) => {
              ...
              Swal.fire(
                "Update Success!",
                "Draft SO telah dikonfirmasi sesuai. Silakan lanjutkan proses entry SO",
                "success"
              );
    ...
    async postSplitDataSO() {
      ...
      try {
        ...
        var docNum = 0;
        var id_tr_ticket_SO_D1 = 0;
        var id_tr_ticket_SO = 0;
        var ii_d1 = 0;
        var ii_d2 = 0;
        ...
        for (let i = 0; i < d; i++) {
          const reqData = await axios({
            method: "post",
            url: mythis.$root.API_ERP + "/wms/saveDataTicketSO_SO/",
            data: {
              dataTr103: mythis.dataTr103,
              ...
              count: i,
              docNum: docNum,
              id_tr_ticket_SO_D1: id_tr_ticket_SO_D1,
              id_tr_ticket_SO: id_tr_ticket_SO,
              ii_d1: ii_d1,
              ii_d2: ii_d2,
            },
          });
          ...
          id_tr_ticket_SO_D1 = resData.id_tr_ticket_SO_D1;
          id_tr_ticket_SO = resData.id_tr_ticket_SO;
          ii_d1 = resData.ii_d1;
          ii_d2 = resData.ii_d2;
      ...
      Swal.fire(
        "Update Success!",
        "Data telah disimpan sementara (Draft). Silakan lanjutkan proses Confirm SO untuk dapat mengentry data SO",
        "success"
      );
      ...
      if (mythis.dataTr103.docNum_SO == null) {
        mythis.close();
        mythis.close2();
        mythis.refreshTable();
      }
    ...
    getTable() {
      ...
      this.grid2.updateConfig({
        ...
        server: {
          url: this.$root.API_ERP + "/wms/pagingTransOut_SO",
          then: (data) =>
            data.results.map((card) => [
              card.id,
              //"",
