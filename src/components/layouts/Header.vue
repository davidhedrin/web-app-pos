  ...
  <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
      <li class="nav-item d-none d-md-block">
        <span>{{ userLogin ? userLogin.nama_lengkap : '' }} {{ storeActive ? `(${storeActive.storeName})` : '' }}</span>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
          ...
          <div class="bg-white dark__bg-1000 rounded-2 py-2">
            <span v-if="userLogin" class="dropdown-item"><span class="far fa-user"></span> {{ userLogin ? userLogin.nama_lengkap : '' }}</span>
            <span v-if="storeActive" class="dropdown-item"><span class="fas fa-store-alt"></span> ({{ storeActive ? storeActive.storeName : '' }})</span>
            <div v-if="userLogin" class="dropdown-divider"></div>
            <a class="dropdown-item" href="javascript:void(0)">Set status</a>
            <a class="dropdown-item" href="javascript:void(0)">Profile &amp; account</a>
            <a class="dropdown-item" href="#!">Feedback</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="javascript:void(0)">Settings</a>
            <a class="dropdown-item d-flex" href="#settings-offcanvas" data-bs-toggle="offcanvas">
              Customized
              <span class="fa-spin d-flex flex-center ms-1">
                <span class="icon-spin d-flex flex-center text-dark">
